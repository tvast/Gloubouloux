...
var Controls_ts_1 = require("./Controls.ts");
var Volume_ts_1 = require('./Volume.ts');
var SongImage_ts_1 = require('./SongImage.ts');
var TimeSeeker_ts_1 = require('./timeSeeker/TimeSeeker.ts');
var TimeInfo_ts_1 = require('./TimeInfo.ts');
