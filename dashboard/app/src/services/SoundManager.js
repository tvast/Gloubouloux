...
var SoundCloudPlayer_1 = require('./SoundCloudPlayer');
var Events_1 = require('../interfaces/Events');
var SoundManagerSoundPlayer_1 = require('./SoundManagerSoundPlayer');
var PlaylistService_1 = require('./PlaylistService');
var SoundManager = (function () {
    ...
    SoundManager.prototype.play = function (song) {
        ...
        this.soundPlayer.initialize(song, function (e) {
            if (!e) {
                ...
                _this.publish(Events_1.Events.ChangeSong, song);
    ...
    SoundManager.prototype.toggleMute = function () {
        if (this.currentSong) {
            if (this.isMute) {
                ...
                this.isMute = false;
                this.publish(Events_1.Events.Volume, false);
            }
            else {
                this.soundPlayer.setVolume(0);
                this.isMute = true;
                this.publish(Events_1.Events.Volume, true);
            }
        }
    };
    ...
    SoundManager.prototype.onSongFinish = function () {
        ...
        if (nextSong) {
            ...
            this.publish(Events_1.Events.Finish, null);
        }
    };
    SoundManager.prototype.subscribSoundPlayerEvent = function (soundPlayer) {
        var _this = this;
        soundPlayer.on(Events_1.Events.Play, function () {
            _this.publish(Events_1.Events.Play, null);
            _this.isPlaying = true;
        });
        soundPlayer.on(Events_1.Events.PlayStart, function () {
            _this.publish(Events_1.Events.PlayStart, null);
            _this.isPlaying = true;
        });
        soundPlayer.on(Events_1.Events.PlayResume, function () {
            _this.publish(Events_1.Events.PlayResume, null);
            _this.isPlaying = true;
        });
        soundPlayer.on(Events_1.Events.Pause, function () {
            _this.publish(Events_1.Events.Pause, null);
            _this.isPlaying = false;
        });
        soundPlayer.on(Events_1.Events.Finish, function () {
            _this.publish(Events_1.Events.Finish, null);
            _this.isPlaying = false;
            _this.onSongFinish();
        });
        soundPlayer.on(Events_1.Events.Seek, function () { return _this.publish(Events_1.Events.Seek, null); });
        soundPlayer.on(Events_1.Events.Seeked, function () { return _this.publish(Events_1.Events.Seeked, null); });
        soundPlayer.on(Events_1.Events.Time, function (time) {
            _this.publish(Events_1.Events.Time, time);
        });
        soundPlayer.on(Events_1.Events.AudioError, function () {
            _this.publish(Events_1.Events.AudioError, null);
            _this.isPlaying = false;
        });
        soundPlayer.on(Events_1.Events.NoStreams, function () { return _this.publish(Events_1.Events.NoStreams, null); });
    };
    SoundManager = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [SoundCloudPlayer_1.SoundCloudPlayer, SoundManagerSoundPlayer_1.SoundManagerSoundPlayer, PlaylistService_1.PlaylistService])
    ], SoundManager);
    return SoundManager;
}());
