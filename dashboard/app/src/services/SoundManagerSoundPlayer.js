    ...
    SoundManagerSoundPlayer.prototype.initialize = function (song, callback) {
        ...
        if (!soundObject) {
            soundObject = soundManager.createSound({
                ...
                volume: 100,
                onbufferchange: function () { return _this.publish(Events_ts_1.Events.BufferingStart, null); },
                ondataerror: function () { return _this.publish(Events_ts_1.Events.AudioError, null); },
                onfinish: function () { return _this.publish(Events_ts_1.Events.Finish, null); },
                onload: function () { return _this.publish(Events_ts_1.Events.BufferingStart, null); },
                onpause: function () { return _this.publish(Events_ts_1.Events.Pause, null); },
                onplay: function () { return _this.publish(Events_ts_1.Events.Play, null); },
                onresume: function () { return _this.publish(Events_ts_1.Events.PlayResume, null); },
                onstop: function () { return _this.publish(Events_ts_1.Events.Finish, null); },
