...
var SoundCloudPlayer = (function () {
    ...
    SoundCloudPlayer.prototype.subscribeSoundCloudPlayerEvent = function () {
        var _this = this;
        this.scPlayer.on('play', function () { return _this.publish(Events_1.Events.Play); });
        this.scPlayer.on('play-start', function () { return _this.publish(Events_1.Events.PlayStart); });
        this.scPlayer.on('play-resume', function () { return _this.publish(Events_1.Events.PlayResume); });
        this.scPlayer.on('pause', function () { return _this.publish(Events_1.Events.Pause); });
        this.scPlayer.on('finish', function () { return _this.publish(Events_1.Events.Finish); });
        this.scPlayer.on('seek', function () { return _this.publish(Events_1.Events.Seek); });
        this.scPlayer.on('seeked', function () { return _this.publish(Events_1.Events.Seeked); });
        this.scPlayer.on('time', function () { return _this.publish(Events_1.Events.Time); });
        this.scPlayer.on('audio_error', function () { return _this.publish(Events_1.Events.AudioError); });
        this.scPlayer.on('no_streams', function () { return _this.publish(Events_1.Events.NoStreams); });
    };
